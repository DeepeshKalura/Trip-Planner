...
def main():
    ...
    country = st.sidebar.text_input("Enter the country", "India")
    city = st.sidebar.text_input("Enter the city", "Goa")
    ...
    with col2:
        ...
        if st.session_state["generate_button_clicked"]:
            with open('/home/deepesh/Development/public/open-source/Gemini-Powered-Trip-Planner/app/gemini_answer.json', 'r', encoding="utf-8") as file:
